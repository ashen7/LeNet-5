...
g++ -g -O3 -w -fopenmp train_and_evaluate_lenet5.cpp src/lenet.cpp src/convolutional_layer.cpp src/filter.cpp \
src/max_pooling_layer.cpp src/neural_network.cpp src/full_connected_layer.cpp tools/read_mnist.cpp -o lenet5 \
